...
import composite.drawable.visitor.SetBoundariesDrawableVisitor;
...
public class MainWindow  {
	...
	private void createDrawable()
	{
		...
		SetBoundariesDrawableVisitor setBoundariesDrawableVisitor = new SetBoundariesDrawableVisitor();
		drawableMoveReference.accept(setBoundariesDrawableVisitor);

		this.drawSelectionBox = new SelectionBox(setBoundariesDrawableVisitor.getBoundaries());
	...
	private class TreeClick implements TreeSelectCallBack
	{
		...
		public void callback(DrawableInfo drawableInfo) {
			...
			SetBoundariesDrawableVisitor setBoundariesDrawableVisitor = new SetBoundariesDrawableVisitor();
			drawableMoveReference.accept(setBoundariesDrawableVisitor);
			drawSelectionBox.updateBoundaries(setBoundariesDrawableVisitor.getBoundaries());
